...
if( !function_exists("wp_bootstrap_theme_styles") ) {  
    function wp_bootstrap_theme_styles() { 
        ...
        wp_register_style( 'main', get_template_directory_uri() . '/stylesheets/build/styles.css', array(), '1.0', 'all' );
        wp_enqueue_style( 'main' );

        wp_register_style( 'wp-style', get_stylesheet_directory_uri() . '/style.css', array(), '1.0', 'all' );
        wp_enqueue_style( 'wp-style' );

        wp_register_style( 'fullpage-css', get_stylesheet_directory_uri() . '/stylesheets/jquery.fullPage.css', array(), '1.0', 'all' );
...
if( !function_exists( "wp_bootstrap_theme_js" ) ) {  
  function wp_bootstrap_theme_js(){
    ...
    wp_register_script( 'bootstrap', 
      get_template_directory_uri() . '/javascripts/build/production.min.js', 
      array('jquery'), 
      '1.2' );
  
    wp_register_script( 'modernizr', 
      get_template_directory_uri() . '/javascripts/modernizr.js', 
      array('jquery'), 
      '1.2' );


    wp_register_script( 'easings', 
      get_template_directory_uri() . '/javascripts/jquery.easings.min.js',
      array('jquery'), 
      '1.2' );

    wp_register_script( 'slimscroll', 
      get_template_directory_uri() . '/javascripts/jquery.slimscroll.min.js',
      array('jquery'), 
      '1.2' );

    wp_register_script( 'fullpage', 
      get_template_directory_uri() . '/javascripts/jquery.fullPage.min.js',
      array('jquery'), 
      '1.2' );
...
function wpdocs_dequeue_script() {
	if ( is_page( 8 ) ) {
		wp_dequeue_style( 'fullpage-css' );
		wp_dequeue_script( 'fullpage' );
	}
}
